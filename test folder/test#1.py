# Save the user's T-Rex Win32 C++ game code to a file and include a quick compile script.
code = '''// T-Rex (Chrome Dino-style) — Pure Win32 API, single file
// ------------------------------------------------------------------
// Features
...
'''
open('trex_win32.cpp', 'w').write(code)

# Provide a simple MinGW build script for convenience.
bat = '''@echo off
setlocal
...
'''
open('build_mingw.bat', 'w').write(bat)

# Quick README
readme = """T-Rex Win32 (C++/GDI)
------------------------
Build options:
...
print("Files saved: /mnt/data/trex_win32.cpp, /mnt/data/build_mingw.bat, README.txt")
